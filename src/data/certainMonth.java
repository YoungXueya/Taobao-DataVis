 ...
 */
@WebServlet("/certainMonth.do")
public class certainMonth extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            for (int i = 1; i <9; ++i) {
                ...
                String sql = "select * from user_info,user_log where user_info.user_id=user_log.user_id and age_range="+i+" and time_stamp like '"+month+"%' group by user_info.user_id";
...
//                System.out.println(ageData[i-1]);
            ...
            for(int i=0;i<3;i++) {
                ...
                String sql = "select * from user_info,user_log where user_info.user_id=user_log.user_id and gender=" + i + " and time_stamp like '"+month+"%'group by user_info.user_id";
                rs = register.executeQuery(sql);
                rs.last();
                int rowCount = rs.getRow();
